export const enMessages = {
  ...
  details: {
    ...
    yearLabel: "Year",
    licenseCalloutStrong: "CC BY-SA 4.0.",
    licenseCalloutBody:
      "Learners and other authors may share and adapt the course, even commercially, as long as they credit the contributors above and release their version under the same license.",
    projectTitle: "Project",
    projectDescription: "Where and how this course is stored.",
    folder: "Folder",
    versionControl: "Version control",
    gitDetail: "Git initialized · 12 commits",
    clean: "Clean",
